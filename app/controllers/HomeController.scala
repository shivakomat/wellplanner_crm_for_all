...
class HomeController @Inject()(cc: ControllerComponents) extends AbstractController(cc) {
  ...
  def welcome = Action {
    ...
    Redirect("https://simple-crm-5528099374a3.herokuapp.com/assets/rubik-presentation-site/well-planner.html")
  }
  ...
  def contactsPage(businessId: Int) = Action {
    Ok(views.html.contacts("Contacts", businessId))
  }

  def tasksPage(businessId: Int) = Action {
    Ok(views.html.tasks("Tasks", businessId))
  }

...
import model.api.projects.{BudgetBreakdownList, NewProjectMessage, SubBreakDownWithPayments, TaskList, TimelineItemsList, BusinessTasks}
...
object JsonFormats {
  ...
  implicit val businessTasksFormat = Json.format[BusinessTasks]

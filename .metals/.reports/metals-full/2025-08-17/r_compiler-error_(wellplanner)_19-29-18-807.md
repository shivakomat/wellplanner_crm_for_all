...
### scala.reflect.internal.FatalError: 
  ThisType(method getPaymentIntent) for sym which is not a class
  ...
  last tree to typer: Ident(stripeResult)
       tree position: line 158 of file://<WORKSPACE>/app/services/PaymentService.scala
            tree tpe: <error>
              symbol: value stripeResult
   symbol definition: stripeResult: <error> (a TermSymbol)
...
== Source file context for tree position ==
   ...
   155       amount = stripeResult.amount,
   156       currency = stripeResult.currency,
   157       status = stripeResult.status,
   158       description = stripeResult.description
   159     )
   160   }
   161 
